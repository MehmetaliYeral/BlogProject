                ...
                <nav class="navbar navbar-light navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <div class="d-flex">
                            ...
                            <form method="POST" action="{{ route('lOut') }}">
                                @csrf
                          <button type="submit" style="background-color: red; color: white; padding: 8px 16px; border: none; border-radius: 4px;">Log Out</button>
                            </form>
                           <li class="nav-item"> 
